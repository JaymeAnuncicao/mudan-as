    ...
    <div class="container text-center text-md-left">
      <div class="row">
        <div class="col-md-6 mt-md-0 mt-3">
          <h5 class="text-uppercase">Telefone: (12)3456789</h5>
          <p>Mecanauto Martinelli &copy; Todos os Direitos Reservados</p>
        </div>
        ...
        <div class="col-md-3 mb-md-0 mb-3">
          ...
          <div class="col-md-3 mb-md-0 mb-3">
            <a href="" class="btn btn-white btn-rounded mb-4" data-toggle="modal" data-target="#modalContactForm">Fale Conosco</a>
          </div>
      </div>
    </div>
  </footer>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="text-center primary-color-dark p-5">
            <h4 class="modal-title text-white w-100 font-weight-bold">Fale Conosco</h4>
            <br>
            ...
            <div class="form-group">
                <textarea name="mensagem" class="form-control rounded" id="exampleFormControlTextarea2" rows="3" placeholder="Mensagem"></textarea>
            </div>
